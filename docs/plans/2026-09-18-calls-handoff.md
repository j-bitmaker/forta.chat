...
- `docs/manual-verification.md` — все починки, которым нужна проверка на аппарате. Раздел «Ожидают проверки» (12
...
17. **«Зависший звонок отпускается при возврате»** — по USB не воспроизводится в принципе (разбор 2026-09-21 в
    записи), а сценарий теперь закрывает пуш об отбое; предложено закрыть решением владельца.
