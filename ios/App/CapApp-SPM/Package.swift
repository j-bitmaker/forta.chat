...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorDeviceInfo", path: "../../../node_modules/@capgo/capacitor-device-info"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "CapgoCapacitorDeviceInfo", package: "CapgoCapacitorDeviceInfo"),
