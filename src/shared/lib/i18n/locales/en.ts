export const en = {
  ...
  "notificationsSettings.fsiTitle": "Incoming calls may not ring on screen",
  "notificationsSettings.fsiHint": "Android has turned off full-screen notifications for Forta Chat, so an incoming call shows only as a small banner that is easy to miss on a locked phone. Allow full-screen notifications to bring the call screen back.",
  "notificationsSettings.fsiOpen": "Allow full-screen notifications",
  ...
  "callFeedback.title": "How was the call?",
  "callFeedback.good": "Good",
  ...
  "callFeedback.problem.echo": "Echo or strange noises",
  "callFeedback.problem.never_connected": "The call never connected",
  "callFeedback.problem.other": "Something else",
  "settings.callEngine.title": "Call engine",
  "settings.callEngine.useNative": "Built-in call engine",
  "settings.callEngine.hint": "Leave this on. Turn it off only if you cannot hear the other person or they cannot hear you — calls then run on the browser engine instead. Takes effect after you restart the app.",
  "settings.callEngine.restartRequired": "Restart the app to apply",
