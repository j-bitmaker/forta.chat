...
export const ru: Record<TranslationKey, string> = {
  ...
  "notificationsSettings.fsiTitle": "Входящий звонок может не подняться на экран",
  "notificationsSettings.fsiHint": "Android отключил полноэкранные уведомления для Forta Chat: входящий звонок показывается маленькой плашкой, которую легко пропустить на заблокированном телефоне. Разрешите полноэкранные уведомления, чтобы вернуть экран звонка.",
  "notificationsSettings.fsiOpen": "Разрешить полноэкранные уведомления",
  ...
  "callFeedback.title": "Как прошёл звонок?",
  "callFeedback.good": "Хорошо",
  ...
  "callFeedback.problem.echo": "Эхо или посторонние звуки",
  "callFeedback.problem.never_connected": "Звонок так и не соединился",
  "callFeedback.problem.other": "Другое",
  "settings.callEngine.title": "Движок звонков",
  "settings.callEngine.useNative": "Встроенный движок звонков",
  "settings.callEngine.hint": "Оставьте включённым. Выключайте только если вас не слышно или не слышно собеседника — тогда звонки пойдут через движок браузера. Изменение вступит в силу после перезапуска приложения.",
  "settings.callEngine.restartRequired": "Перезапустите приложение, чтобы применить",
